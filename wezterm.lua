...
wezterm.on("gui-startup", function()
  ...
  -- Set a workspace for coding on rust
  local project_dir = "C:\\Users\\kusha"
  ...
  --[[
  -- Set a workspace for coding on rust
  local rust_project_dir = "C:\\Users\\kusha\\Desktop\\progs\\rust"
  local tab, build_pane, window = mux.spawn_window({
    workspace = "rust",
    cwd = rust_project_dir,
  })

  -- Set a workspace for coding on go
  local go_project_dir = "C:\\Users\\kusha\\Desktop\\progs\\go"
  local tab, build_pane, window = mux.spawn_window({
    workspace = "go",
    cwd = go_project_dir,
  })
  -- Set a workspace for configuring nvim
  local nvim_project_dir = "C:\\Users\\kusha\\AppData\\Local\\nvim"
  local tab, build_pane, window = mux.spawn_window({
    workspace = "nvim",
    cwd = nvim_project_dir,
  })

  -- Set a workspace for configuring wezterm
  local wezterm_project_dir = "C:\\Users\\kusha\\.config\\wezterm"
  local tab, build_pane, window = mux.spawn_window({
    workspace = "wezterm",
    cwd = wezterm_project_dir,
  })
--]]
